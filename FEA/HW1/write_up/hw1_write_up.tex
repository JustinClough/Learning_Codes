...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm, height=11cm]{error_plot_1}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm, height=11cm]{log_error_plot_1}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm, height=11cm]{error_plot_2}
  \caption{ Error in solution over domain of problem.}
  \label{fig:Error2}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm, height=11cm]{log_error_plot_2}
  \caption{ Log of error in solution over domain of problem.}
  \label{fig:logError2}
\end{figure}
